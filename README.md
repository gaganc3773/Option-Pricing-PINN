...
### **Error Analysis**
- Error Analysis only available for european option - `closed form solution given above`
```python
...
### **Access Points**
- **Backend API**: http://localhost:8000  - `removed the local host api_base - need to rewrite it in main.py if want to check the local host working`
